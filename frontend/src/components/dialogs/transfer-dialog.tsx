...
interface TransferDialogProps {
  ...
  onTranferSuccess: () => void; 
}

export function TransferDialog({ balance, open, onOpenChange, onTranferSuccess }: TransferDialogProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="bg-white sm:max-w-md">
        <DialogHeader className="text-center">
          ...
          <DialogDescription>
            Envie dinheiro para outros usuários da carteira digital
          </DialogDescription>
        </DialogHeader>

        <div className="mb-6 p-4 bg-muted/50 rounded-lg">
          <p className="text-sm text-muted-foreground">Saldo disponível:</p>
          <p className="text-lg font-semibold text-[#0476ae]">
